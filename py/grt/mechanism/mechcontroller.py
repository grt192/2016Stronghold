...
class MechController:
    ...
    def __init__(self, driver_joystick, xbox_controller, mimic_joystick, switch_panel, shooter, pickup,
    ...
    def _dummy_vision_listener(self, sensor, state_id, datum):
        ...
        if type(self.robot_vision) == Mimic:
            ...
            if state_id == "y_axis":
                ...
                self.shooter.turntable.encoder.position = int(datum * 4000)
                print("ENCODER POSITION: ", self.shooter.turntable.encoder.position)
