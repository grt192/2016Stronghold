class MechController:
    ...
    def __init__(self, driver_joystick, xbox_controller, switch_panel, pickup, shooter, operation_manager, override_manager, portcullis_macro=None, chival_macro=None): # mechanisms belong in arguments
    ...
    def _xbox_controller_listener(self, sensor, state_id, datum):
        ...
        if self.override_manager.tt_override:
            if state_id == "r_x_axis":
                if datum:
                    self.shooter.turntable.joystick_turn(-datum*.5)
        ...
        """
        Immediately fire a shot into the low goal
        """
