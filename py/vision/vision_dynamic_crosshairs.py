...
while True:
	...
	if target_polygon == None:
		...
		distance = 275.56 * (math.e ** (-.008*avg_height))
		#print(avg_height, ",")
		#for vector in y_mat:
		#	print(vector[3])
		x_cm = int(moments['m10']/moments['m00'])
		y_cm = int(moments['m01']/moments['m00'])
		#print("\nX_cm: ", x_cm)
		#print("Y_cm: ", y_cm)
		x_target = int(width / 2)
		y_target = int(height / 2)
		cv2.circle(img, (x_cm, y_cm), 20, (255, 0, 0))
		cv2.circle(img, (x_target, y_target), 20, (0, 0, 255))

		allowed_error = 20
		if abs(x_target - x_cm) < allowed_error:
