...
from grt.macro.portcullis_macro import PortcullisMacro
from grt.macro.chival_macro import ChivalMacro

from grt.mechanism.nt_ticker import NTTicker
from collections import OrderedDict

from grt.macro.low_bar_macro import LowBarMacro
from grt.autonomous.low_bar_auto import LowBarAuto

from grt.macro.cheval_macro import ChevalMacro

from grt.macro.new_turn_macro import NewTurnMacro
from grt.macro.dual_low_goal import DualLowGoal
...
flywheel_motor.setPID(.33, 0, 0, f=.17) #Omega 1 tuning constants
#flywheel_motor.setPID(.1, 0, 0, f=.209) #Omega 2 tuning constants
...
turntable_motor.setPID(80, 0, 0, f=0)
turntable_motor.configMaxOutputVoltage(8)
turntable_motor.setAllowableClosedLoopErr(1)
...
new_turn_macro = NewTurnMacro(0, navx, dt)

# one_cross_auto = OneCrossAuto(straight_macro)

# Macros
portcullis_macro = PortcullisMacro(pickup, straight_macro)
